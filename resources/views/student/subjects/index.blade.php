    ...
    <div id="catalogCardsContainer" class="ed-subjects-grid">
        ...
        @empty
            <div class="ed-empty-catalog-box">
                ...
                <p>{{ __('يرجى التواصل مع المشرف العام أو مراجعة إدارة المنصة لربط مواد مسارك الأكاديمي، أو استعراض باقات المواد المتاحة.') }}</p>
                <a href="{{ route('courses.catalog') }}" class="btn-browse-catalog">
                    <i class="fa-solid fa-layer-group"></i>
                    <span>{{ __('استعراض باقات ومقررات التوجيهي') }}</span>
                </a>
            </div>
        @endforelse
    </div>
