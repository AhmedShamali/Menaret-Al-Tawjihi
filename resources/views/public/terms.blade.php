    ...
    <div class="glass-card" style="padding: 60px; border: none; background: white; border-top: 10px solid var(--primary);">
        ...
        <div style="line-height: 2; color: #475569; font-size: 1.1rem;">
            <div class="term-box" style="margin-bottom: 25px; padding: 20px; background: #f8fafc; border-radius: 15px;">
                <strong>{{ __('المحتوى التعليمي:') }}</strong>{{ __('جميع الفيديوهات والملفات ملكية خاصة للمنصة ويمنع نشرها أو تداولها خارج الموقع.') }}</div>
            <div class="term-box" style="margin-bottom: 25px; padding: 20px; background: #f8fafc; border-radius: 15px;">
                <strong>{{ __('السلوك الأكاديمي:') }}</strong>{{ __('يلتزم الطالب بالأمانة العلمية في الاختبارات، وأي محاولة غش تعرض الحساب للحظر النهائي.') }}</div>
        </div>
    </div>
</div>
@endsection
