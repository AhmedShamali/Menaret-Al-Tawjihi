...
<body>
    <div class="error-card">
        <div class="error-badge">
            <i class="fa-solid fa-compass"></i> رمز الخطأ 404
        </div>
        <div class="error-icon">
            <i class="fa-solid fa-graduation-cap"></i>
        </div>
        <h1>عذراً، الصفحة المطلوبة غير متاحة</h1>
        <p>
            ربما تم نقل الصفحة أو تعديل مسارها الأكاديمي، أو أن الرابط المدخل غير دقيق.
            يمكنك العودة إلى لوحة التحكم الرئيسية لمتابعة دراستك.
        </p>
        <div>
