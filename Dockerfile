...
CMD sh -c "php artisan key:generate --no-interaction --force --ansi || true && php artisan migrate --force && php artisan config:clear && php artisan cache:clear && php artisan route:clear && apache2-foreground"
