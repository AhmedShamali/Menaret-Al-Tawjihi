...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $defaultSettings = [
            ...
            'site_description'      => 'منصة تعليمية متكاملة لطلبة التوجيهي تشمل شروحات مرئية للمنهاج، بنك أسئلة، بطاقات ذكية، وحاسبة دقيقة لمعدل الثانوية العامة.',
            'contact_email'         => 'ahmed.shamali@tawjihi.ps',
            'contact_whatsapp'      => '00970597694385',
            'contact_phone'         => '0567897212',
            'registration_status'   => 'open',
            'payment_account_name'  => 'م.أحمد شمالي',
            'supervisor_name'       => 'م.أحمد شمالي',
            'supervisor_name_en'    => 'Eng.Ahmed Shamali',
